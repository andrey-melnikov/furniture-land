...
namespace MoreMountains.NiceVibrations
{
	...
	public static class MMVibrationManager
	{
        ...
        public static void Haptic(long impact, int amplitude)
        {
            if (!_vibrationsActive)
            {
                return;
            ...
            long[] impactPattern = { 0, impact };
            int[] amplitudePattern = { 0, amplitude };

            MMNVAndroid.AndroidVibrate (impactPattern, amplitudePattern, -1);
        }
